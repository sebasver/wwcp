...
public class EntityDonder2 extends GenericRailTransport {
    ...
    public static final Item thisItem = new ItemTransport(new EntityDonder2(null), worldwidecontentpack.MODID , worldwidecontentpack.Germany);
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/rollingstock/DonderBushe/B1.png", "Blue Donnerbüsche ", "Factory blue version");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/rollingstock/DonderBushe/G1.png", "Green Donnerbüsche ", "Factory green version");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/rollingstock/DonderBushe/R1.png", "Red Donnerbüsche ", "Factory red version");
    }
