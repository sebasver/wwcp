...
public class EntityT32Christmas extends GenericRailTransport {
    ...
    public String transportName() {
        return SuperStat.T32TenderChristmas().name;
    }

    public String transportcountry() {
        return SuperStat.T32TenderChristmas().country;
    }
    ...
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(SuperStat.T32TenderChristmas().additionalTextTitle) + SuperStat.T32TenderChristmas().additionalText,
                RailUtility.translate(SuperStat.T32TenderChristmas().additionalTextTitle2) + SuperStat.T32TenderChristmas().additionalText2};}
    }
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/passengerstock/RheingoldChristmas/ChristmasT32.png", new String[]{"textures/bogies/T32Bogie/T32BogieBlack.png"},
                "Christmas Livery", "The standarized T32 tender paint while in use for the DB");
    }

    public boolean isReinforced() {
        return SuperStat.T32TenderChristmas().reinforced;
    }
