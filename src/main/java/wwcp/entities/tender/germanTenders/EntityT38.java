...
public class EntityT38 extends GenericRailTransport {
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/tenders/germanTenders/T38.png", new String[]{"textures/bogies/EUBogies/germanTenderBogies/T37BogieBlack.png"},
                "DB", "The standarized T38 tender paint while in use for the DB");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/tenders/germanTenders/T38DRG.png", new String[]{"textures/bogies/EUBogies/germanTenderBogies/T37BogieBlack.png"},
