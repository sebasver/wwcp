...
public class EntityRheingoldSpeiseTwoChristmas extends GenericRailTransport {
    ...
    public static final Item thisItem = new ItemTransport(new EntityRheingoldSpeiseTwoChristmas(null), worldwidecontentpack.MODID , worldwidecontentpack.Germany);
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/passengerstock/RheingoldChristmas/ChristmasSpeise2.png", "textures/bogies/RheingoldBogie.png",
                "NAME", "Description");
    }
    @Override
