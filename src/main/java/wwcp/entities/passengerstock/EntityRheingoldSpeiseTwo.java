...
import wwcp.models.passengerStock.Rheingold.RheingoldSpeiseTwo;
...
public class EntityRheingoldSpeiseTwo extends GenericRailTransport {
    ...
    public boolean isReinforced() {
        return Transport.RheingoldKitchen2().reinforced;
    }
    ...
    public float weightKg() {
        return Transport.RheingoldKitchen2().weightinKGs;
    }
    ...
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.RheingoldKitchen2().additionalTextTitle) + Transport.RheingoldKitchen2().additionalText,
                RailUtility.translate(Transport.RheingoldKitchen2().additionalTextTitle2) + Transport.RheingoldKitchen2().additionalText2};}
    }
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{3.70f,0f,0},{-3.70f,0f,0}};
    }
    ...
    public float[][] modelOffsets() {
        return new float[][]{{-0.225f,0F,0.F}};
    }

    @Override
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/passengerstock/RheingoldSet/Speise2.png", "textures/bogies/EUBogies/RheingoldBogie.png",
                "NAME", "Description");
    }
    @Override
