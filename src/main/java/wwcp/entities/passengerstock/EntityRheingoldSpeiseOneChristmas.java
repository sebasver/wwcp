...
public class EntityRheingoldSpeiseOneChristmas extends GenericRailTransport {
    ...
    public static final Item thisItem = new ItemTransport(new EntityRheingoldSpeiseOneChristmas(null), worldwidecontentpack.MODID , worldwidecontentpack.Germany);
