...
import wwcp.models.passengerStock.Christmas.ChristmasSpeise1;
...
public class EntityRheingoldSpeiseOneChristmas extends GenericRailTransport {
    ...
    public static final Item thisItem = new WWCPTransport(new EntityRheingoldSpeiseOneChristmas(null), worldwidecontentpack.MODID , worldwidecontentpack.WWCPTab);
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/passengerstock/ChristmasStock/ChristmasSpeise1.png", "textures/bogies/EUBogies/RheingoldBogie.png",
                "NAME", "Description");
    }
    @Override
