...
import wwcp.models.passengerStock.Christmas.ChristmasSalon1;
...
public class EntityRheingoldSalonOneChristmas extends GenericRailTransport {
    ...
    public static final Item thisItem = new WWCPTransport(new EntityRheingoldSalonOneChristmas(null), worldwidecontentpack.MODID , worldwidecontentpack.WWCPTab);
    ...
    public float[][] modelOffsets() {
        return new float[][]{{-0.1925f,-0,0.F}};
    }

    @Override
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/passengerstock/ChristmasStock/ChristmasSalon1.png", "textures/bogies/EUBogies/RheingoldBogie.png",
                "NAME", "Description");
    }
    @Override
