...
import wwcp.models.passengerStock.Christmas.ChristmasSalon2;
...
public class EntityRheingoldSalonTwoChristmas extends GenericRailTransport {
    ...
    public static final Item thisItem = new WWCPTransport(new EntityRheingoldSalonTwoChristmas(null), worldwidecontentpack.MODID , worldwidecontentpack.WWCPTab);
    ...
    public boolean isReinforced() {
        return Transport.RheingoldSalon2Christmas().reinforced;
    }
    ...
    public float weightKg() {
        return Transport.RheingoldSalon2Christmas().weightinKGs;
    }
    ...
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.RheingoldSalon2Christmas().additionalTextTitle) + Transport.RheingoldSalon2Christmas().additionalText,
                RailUtility.translate(Transport.RheingoldSalon2Christmas().additionalTextTitle2) + Transport.RheingoldSalon2Christmas().additionalText2};}
    }
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/passengerstock/ChristmasStock/ChristmasSalon2.png", "textures/bogies/EUBogies/RheingoldBogie.png",
                "NAME", "Description");
    }
    @Override
