...
public class EntityHbbins extends GenericRailTransport {
    ...
    public static final Item thisItem = new WWCPTransport(new EntityHbbins((World)null), worldwidecontentpack.MODID, worldwidecontentpack.European);
