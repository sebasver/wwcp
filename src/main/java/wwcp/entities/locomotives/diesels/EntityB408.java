...
import wwcp.models.locomotives.diesels.B408;
 ...
 */
public class EntityB408 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityB408(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityB408(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityB408(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.B408().name; }


    @Override
    public String transportcountry() { return Transport.B408().country; }

    @Override
    public String transportYear() { return Transport.B408().year; }

    @Override
    public String transportFuelType() {
        return Transport.B408().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.B408().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.B408().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.B408().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.B408().weightinKGs;
    }
    public boolean isReinforced() { return Transport.B408().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.B408().additionalTextTitle) + Transport.B408().additionalText,
                RailUtility.translate(Transport.B408().additionalTextTitle2) + Transport.B408().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.B408().backTopSpeed: Transport.B408().topSpeed;}
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/B408/B408_BNSF.png", "textures/bogies/AmericanTrucks/FB2_Truck_BNSF.png",
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{2.5f,0f,0},{-2.5f,0f,0}};
    }
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-2.75f,1.4f, -0.35f}};}
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new B408()};}
