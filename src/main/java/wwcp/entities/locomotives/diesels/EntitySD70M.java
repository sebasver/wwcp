 ...
 */
public class EntitySD70M extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntitySD70M(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntitySD70M(UUID owner, World world, double xPos, double yPos, double zPos) {
    ...
    @Override
    public String transportName() { return Transport.SD70M().name; }

    @Override
    public String transportcountry() { return Transport.SD70M().country; }

    @Override
    public String transportYear() { return Transport.SD70M().year; }

    @Override
    public String transportFuelType() {
        return Transport.SD70M().fuel;
    }
    @Override
    ...
    public float transportTractiveEffort() {
        return Transport.SD70M().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.SD70M().metric_horsepower;
    }
    @Override
    public float weightKg() {
        return  Transport.SD70M().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.SD70M().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.SD70M().additionalTextTitle) + Transport.SD70M().additionalText,
                RailUtility.translate(Transport.SD70M().additionalTextTitle2) + Transport.SD70M().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.SD70M().backTopSpeed: Transport.SD70M().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_UP.png", "textures/bogies/HTSCtruck_UP2.png",
                "UP", "Union Pacific armour yellow");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_UPSP.png", "textures/bogies/HTSCtruck_UP2.png",
                "UP Ex. SP", "Union Pacific armour yellow, Ex. SP");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_SP.png", "textures/bogies/HTSCtruck_SP.png",
                "SP", "Southern Pacific Bloody Nose");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_NYSW.png", "textures/bogies/HTSCtruck_Black.png",
                "NYSW", "New York, Susquehanna & Western Yellow");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_CSXYN2.png", "textures/bogies/HTSCtruck_Black.png",
                "CSX", "CSX Transportation YN2");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_CSXYN2SOM.png", "textures/bogies/HTSCtruck_Black.png",
                "CSX Spirit of Miami", "CSX Transportation YN2 Spirit of Miami");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70M/SD70M_Template.png", "textures/bogies/HTSCtruck_Black.png",
                "Primer Unit", "SD70M in Primer");
