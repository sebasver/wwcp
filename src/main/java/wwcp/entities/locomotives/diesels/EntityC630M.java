...
import wwcp.models.bogies.AmericanTrucks.DofascoTruck;
import wwcp.models.bogies.AmericanTrucks.DofascoTruckR;
import wwcp.models.bogies.AmericanTrucks.HiAd4Axel;
import wwcp.models.bogies.AmericanTrucks.Type_B;
import wwcp.models.locomotives.diesels.C630;
 ...
 */
public class EntityC630M extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityC630M(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityC630M(UUID owner, World world, double xPos, double yPos, double zPos) {
    ...
    @Override
    public String transportName() { return Transport.C630M().name; }


    @Override
    public String transportcountry() { return Transport.C630M().country; }

    @Override
    public String transportYear() { return Transport.C630M().year; }

    @Override
    public String transportFuelType() {
        return Transport.C630M().fuel;
    }
    @Override
    ...
    public float transportTractiveEffort() {
        return Transport.C630M().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.C630M().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.C630M().weightinKGs;
    }
    public boolean isReinforced() { return Transport.C630M().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.C630M().additionalTextTitle) + Transport.C630M().additionalText,
                RailUtility.translate(Transport.C630M().additionalTextTitle2) + Transport.C630M().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.C630M().backTopSpeed: Transport.C630M().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C630/C630M_PGE.png",
                "PGE", "Pacific Great Eastern in 2 tone lightning stripe green").setBogieTextures(new String[] {"textures/bogies/Dofasco_Truck.png", "textures/bogies/Dofasco_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C630/C630M_BCOL.png",
                "BCOL 2 Tone", "British Columbia Railway in 2 tone lightning stripe green").setBogieTextures(new String[] {"textures/bogies/Dofasco_Truck.png", "textures/bogies/Dofasco_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C630/C630M_BCRAIL.png",
                "BCOL Social Credit RWB", "British Columbia Railway in social credit RWB").setBogieTextures(new String[] {"textures/bogies/Dofasco_Truck_Silver.png", "textures/bogies/Dofasco_Truck_Silver.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C630/C630M_CP.png",
                "CP Action Red", "Canadian Pacific action red w/ multimark").setBogieTextures(new String[] {"textures/bogies/Dofasco_Truck.png", "textures/bogies/Dofasco_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C630/C630M_CN.png",
                "CN", "Canadian National stripped").setBogieTextures(new String[] {"textures/bogies/Dofasco_Truck.png", "textures/bogies/Dofasco_Truck.png"}));
    ...
    public Bogie[] bogies() {
        ...
        return new Bogie[]{
                new Bogie(new DofascoTruck(), -2.95f, 0f, 0),
                new Bogie(new DofascoTruckR(), 2.95f, 0f, 0)
        };
    }
    ...
    public ModelBase[] bogieModels() {
        return new ModelBase[]{new DofascoTruck(), new DofascoTruckR()};
    }
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-3.0f,1.4f, -0.3f}};}
    ...
    public float[] getHitboxSize() {
        return new float[]{9.25f,2f,1.5f};
    }
    ...
    public String[] setParticles(){
        ...
        return new String[]{"smoke ,0,1.8,0.9,0,0,0,0"};
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new C630()};}
