...
public class EntityTraxxP160DE extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityTraxxP160DE(null), worldwidecontentpack.MODID, worldwidecontentpack.European);
     ...
     * @see EntityTrainCore
     */
    public EntityTraxxP160DE(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }

    public EntityTraxxP160DE(World world) {
        super(world);
    }

    @Override
    public String transportName() {
        return Transport.P160DE().name;
    }

    @Override
    public String transportcountry() {
        return Transport.P160DE().country;
    }

    @Override
    public String transportYear() {
        return Transport.P160DE().year;
    }

    @Override
    public String transportFuelType() {
        return Transport.P160DE().fuel;
    }

    @Override
    public boolean isFictional() {
        return Transport.P160DE().fictional;
    }

    @Override
    public float transportTractiveEffort() {
        return Transport.P160DE().tractive_effort;
    }

    @Override
    public float transportMetricHorsePower() {
        return Transport.P160DE().metric_horsepower;
    }

    @Override
    public float weightKg() {
        return Transport.P160DE().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.P160DE().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {
            return new String[]{RailUtility.translate(Transport.P160DE().additionalTextTitle) + Transport.P160DE().additionalText,
                    RailUtility.translate(Transport.P160DE().additionalTextTitle2) + Transport.P160DE().additionalText2};
        }
    }

    @Override
    public float transportTopSpeed() {
        return accelerator < 0 ? Transport.P160DE().backTopSpeed : Transport.P160DE().topSpeed;
    }
