...
import wwcp.models.locomotives.diesels.SD60MAC;
 ...
 */
public class EntitySD60Mac extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntitySD60Mac(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntitySD60Mac(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntitySD60Mac(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.SD60Mac().name; }

    @Override
    public String transportcountry() { return Transport.SD60Mac().country; }

    @Override
    public String transportYear() { return Transport.SD60Mac().year; }

    @Override
    public String transportFuelType() {
        return Transport.SD60Mac().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.SD60Mac().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.SD60Mac().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.SD60Mac().metric_horsepower;
    }
    @Override
    public float weightKg() {
        return  Transport.SD60Mac().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.SD60Mac().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.SD60Mac().additionalTextTitle) + Transport.SD60Mac().additionalText,
                RailUtility.translate(Transport.SD60Mac().additionalTextTitle2) + Transport.SD60Mac().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.SD60Mac().backTopSpeed: Transport.SD60Mac().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD60MAC/SD60MAC_BN_GM_Beacon.png",
                "textures/bogies/HTSCtruck_Black.png",
                "BN-GM Demonstrator with beacon & winterization hatch", "Burlington Northern - General Motors joint test unit scheme for the first emd ac traction motor");
    }
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new SD60MAC()};}
