 ...
 */
public class EntitySD70 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntitySD70(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntitySD70(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntitySD70(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.SD70().name; }

    @Override
    public String transportcountry() { return Transport.SD70().country; }

    @Override
    public String transportYear() { return Transport.SD70().year; }

    @Override
    public String transportFuelType() {
        return Transport.SD70().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.SD70().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.SD70().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.SD70().metric_horsepower;
    }
    @Override
    public float weightKg() {
        return  Transport.SD70().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.SD70().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.SD70().additionalTextTitle) + Transport.SD70().additionalText,
                RailUtility.translate(Transport.SD70().additionalTextTitle2) + Transport.SD70().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.SD70().backTopSpeed: Transport.SD70().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70/SD70_IC.png", "textures/bogies/HTSCtruck_Black.png",
                "IC", "Illinois Central black, nicknamed 'Death Star'");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/SD70/SD70_NS.png", "textures/bogies/HTSCtruck_Black.png",
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new SD70()};}
