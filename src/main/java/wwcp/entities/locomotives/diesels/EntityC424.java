 ...
 */
public class EntityC424 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityC424(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityC424(UUID owner, World world, double xPos, double yPos, double zPos) {
    ...
    @Override
    public String transportName() { return Transport.C424().name; }


    @Override
    public String transportcountry() { return Transport.C424().country; }

    @Override
    public String transportYear() { return Transport.C424().year; }

    @Override
    public String transportFuelType() {
        return Transport.C424().fuel;
    }
    @Override
    ...
    public float transportTractiveEffort() {
        return Transport.C424().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.C424().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.C424().weightinKGs;
    }
    public boolean isReinforced() { return Transport.C424().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.C424().additionalTextTitle) + Transport.C424().additionalText,
                RailUtility.translate(Transport.C424().additionalTextTitle2) + Transport.C424().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.C424().backTopSpeed: Transport.C424().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C4245/C424_SPS.png",
        ...
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C4245/C424_WAB.png",
                "Wabash", "Rejected by NdeM, sold to Wabash, banned from leading due to spannish labeled controls").setBogieTextures(new String[] {"textures/bogies/Type_B_Truck.png", "textures/bogies/Type_B_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C4245/C424_CN.png",
                "CN", "Canadian National noodle black").setBogieTextures(new String[] {"textures/bogies/Type_B_Truck.png", "textures/bogies/Type_B_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C4245/C424_CPLate.png",
                "CP Late", "Canadian Pacific action red w/o multimark").setBogieTextures(new String[] {"textures/bogies/Type_B_Truck.png", "textures/bogies/Type_B_Truck.png"}));
