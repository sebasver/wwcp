...
import wwcp.models.locomotives.diesels.GP50;
 ...
 */
public class EntityGP50 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityGP50(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityGP50(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityGP50(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.GP50().name; }

    @Override
    public String transportcountry() { return Transport.GP50().country; }

    @Override
    public String transportYear() { return Transport.GP50().year; }

    @Override
    public String transportFuelType() {
        return Transport.GP50().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.GP50().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.GP50().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.GP50().metric_horsepower;
    }
    @Override
    public float weightKg() {
        return  Transport.GP50().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.GP50().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.GP50().additionalTextTitle) + Transport.GP50().additionalText,
                RailUtility.translate(Transport.GP50().additionalTextTitle2) + Transport.GP50().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.GP50().backTopSpeed: Transport.GP50().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/GP50/BN_Tiger_Face.png",
                "textures/bogies/blombergB_black.png",
                "BN Tiger Face", "Burlington Northern Tiger Face; Orange & Black Stripes on nose");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/GP50/BN_White_Face.png",
                "textures/bogies/blombergB_black.png",
                "BN White Face", "Burlington Northern White Face; front white with bn logo on nose");
    }

    @Override
    public String getDefaultSkin() {
        return worldwidecontentpack.MODID + ":BN White Face";
    }
     ...
     */
    @Override
    public ModelBase[] bogieModels() {return new ModelBase[]{new Blomberg_B(), new Blomberg_B()}; }

    @Override
    public float[][] bogieModelOffsets() {
        return new float[][]{{2.5f,0f,0},{-2f,0f,0}};
    }
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new GP50()};}
