...
import wwcp.models.locomotives.diesels.MK5000C;
 ...
 */
public class EntityMK5000C extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityMK5000C(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityMK5000C(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityMK5000C(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.MK5000C().name; }

    @Override
    public String transportcountry() { return Transport.MK5000C().country; }

    @Override
    public String transportYear() { return Transport.MK5000C().year; }

    @Override
    public String transportFuelType() {
        return Transport.MK5000C().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.MK5000C().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.MK5000C().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.MK5000C().metric_horsepower;
    }
    @Override
    public float weightKg() {
        return  Transport.MK5000C().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.MK5000C().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.MK5000C().additionalTextTitle) + Transport.MK5000C().additionalText,
                RailUtility.translate(Transport.MK5000C().additionalTextTitle2) + Transport.MK5000C().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.MK5000C().backTopSpeed: Transport.MK5000C().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/MK5000C/MK5000C_SP.png", "textures/bogies/AmericanTrucks/Dofasco_SP.png",
                "Southern Pacific", "Southern Pacific Bloody Nose Demonstrators");
     ...
     */
    @Override
    public ModelBase[] bogieModels() {return new ModelBase[]{new DofascoTruck(), new DofascoTruckR()}; }
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-3.15f,1.45f, -0.3f}};}
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new MK5000C()};}
