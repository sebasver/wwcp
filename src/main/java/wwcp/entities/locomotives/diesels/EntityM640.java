...
import wwcp.models.locomotives.diesels.M640;
 ...
 */
public class EntityM640 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityM640(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityM640(UUID owner, World world, double xPos, double yPos, double zPos) {
    ...
    @Override
    public String transportName() { return Transport.M640().name; }

    @Override
    public String transportcountry() { return Transport.M640().country; }

    @Override
    public String transportYear() { return Transport.M640().year; }

    @Override
    public String transportFuelType() {
        return Transport.M640().fuel;
    }
    @Override
    ...
    public float transportTractiveEffort() {
        return Transport.M640().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.M640().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.M640().weightinKGs;
    }
    public boolean isReinforced() { return Transport.M640().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.M640().additionalTextTitle) + Transport.M640().additionalText,
                RailUtility.translate(Transport.M640().additionalTextTitle2) + Transport.M640().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.M640().backTopSpeed: Transport.M640().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/M640/M640_CP_AC_Traction.png",
                "textures/bogies/Dofasco_Truck.png",
                "CP Action Red; AC Traction", "Canadian Pacific M640 using first ever ac traction motor");
    }

    public String getDefaultSkin(){
        return worldwidecontentpack.MODID+":"+"CP Action Red; AC Traction";
    }
     ...
     */
    @Override
    public ModelBase[] bogieModels() {return new ModelBase[]{new DofascoTruck()}; }

    @Override
    public float[][] bogieModelOffsets() {
        return new float[][]{{2.6f,0f,0},{-3.1f,0f,0}};
    }
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new M640()};}
