...
import wwcp.models.locomotives.diesels.B307aH;
 ...
 */
public class EntityB307a extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityB307a(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityB307a(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityB307a(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.B307a().name; }


    @Override
    public String transportcountry() { return Transport.B307a().country; }

    @Override
    public String transportYear() { return Transport.B307a().year; }

    @Override
    public String transportFuelType() {
        return Transport.B307a().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.B307a().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.B307a().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.B307a().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.B307a().weightinKGs;
    }
    public boolean isReinforced() { return Transport.B307a().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.B307a().additionalTextTitle) + Transport.B307a().additionalText,
                RailUtility.translate(Transport.B307a().additionalTextTitle2) + Transport.B307a().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.B307a().backTopSpeed: Transport.B307a().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/B307a/B307a_NS.png",
                "textures/bogies/AmericanTrucks/FB2_Truck_Black.png",
                "NS", "Norfolk Southern w/ Ditchlights");
    }
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-2.75f,1.25f, -0.35f}};}
    ...
    public String[] setParticles(){
        ...
        return new String[]{"smoke ,0,1.1,0.9,0,0,0,0"};
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new B307aH()};}
