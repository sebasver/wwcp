...
import wwcp.models.locomotives.diesels.B398;
 ...
 */
public class EntityB398 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityB398(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityB398(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityB398(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.B398().name; }


    @Override
    public String transportcountry() { return Transport.B398().country; }

    @Override
    public String transportYear() { return Transport.B398().year; }

    @Override
    public String transportFuelType() {
        return Transport.B398().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.B398().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.B398().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.B398().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.B398().weightinKGs;
    }
    public boolean isReinforced() { return Transport.B398().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.B398().additionalTextTitle) + Transport.B398().additionalText,
                RailUtility.translate(Transport.B398().additionalTextTitle2) + Transport.B398().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.B398().backTopSpeed: Transport.B398().topSpeed;}
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new B398()};}
