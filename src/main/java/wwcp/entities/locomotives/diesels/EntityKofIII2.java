...
import wwcp.models.locomotives.KoFIII2;
...
public class EntityKofIII2 extends EntityTrainCore {
    ...
    public static final Item thisItem = new ItemTransport(new EntityKofIII2(null), worldwidecontentpack.MODID,worldwidecontentpack.European);
    ...
    @Override
    public String transportName() { return SuperStat.KoFIII2().name; }

    @Override
    public String transportcountry() { return SuperStat.KoFIII2().country; }

    @Override
    public String transportYear() { return SuperStat.KoFIII2().year; }

    @Override
    public String transportFuelType() {
        return SuperStat.KoFIII2().fuel;
    }
    @Override
    public boolean isFictional() {
        return SuperStat.KoFIII2().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return SuperStat.KoFIII2().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return SuperStat.KoFIII2().metric_horsepower;
    }
    @Override
    public float weightKg() {
        return  SuperStat.KoFIII2().weightinKGs;
    }

    public boolean isReinforced() {
        return SuperStat.KoFIII2().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(SuperStat.KoFIII2().additionalTextTitle) + SuperStat.KoFIII2().additionalText,
                RailUtility.translate(SuperStat.KoFIII2().additionalTextTitle2) + SuperStat.KoFIII2().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0?SuperStat.KoFIII2().backTopSpeed:SuperStat.KoFIII2().topSpeed;}
