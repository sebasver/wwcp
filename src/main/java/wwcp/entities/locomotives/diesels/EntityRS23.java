...
import wwcp.models.locomotives.diesels.RS23;
 ...
 */
public class EntityRS23 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityRS23(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityRS23(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRS23(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.RS23().name; }

    @Override
    public String transportcountry() { return Transport.RS23().country; }

    @Override
    public String transportYear() { return Transport.RS23().year; }

    @Override
    public String transportFuelType() {
        return Transport.RS23().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.RS23().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.RS23().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.RS23().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.RS23().weightinKGs;
    }
    public boolean isReinforced() { return Transport.RS23().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.RS23().additionalTextTitle) + Transport.RS23().additionalText,
                RailUtility.translate(Transport.RS23().additionalTextTitle2) + Transport.RS23().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.RS23().backTopSpeed: Transport.RS23().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/RS23/RS23_CP_Script.png",
                "textures/bogies/Type_B_Truck.png",
                "CP Script", "Canadian Pacific with script lettering");
    }
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{2.1f,1.35f, -0.4f}};}
    ...
    public int[] getParticleData(int id) {
        switch (id){
            case 0:{return new int[]{2, 45, 0x555555};}//ALCO smoke
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new RS23()};}
