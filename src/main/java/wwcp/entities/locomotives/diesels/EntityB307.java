 ...
 */
public class EntityB307 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityB307(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityB307(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityB307(World world){
        super(world);
    }

    @Override
    public String transportName() { return Transport.B307().name; }


    @Override
    public String transportcountry() { return Transport.B307().country; }

    @Override
    public String transportYear() { return Transport.B307().year; }

    @Override
    public String transportFuelType() {
        return Transport.B307().fuel;
    }
    @Override
    public boolean isFictional() {
        return Transport.B307().fictional;
    }
    @Override
    public float transportTractiveEffort() {
        return Transport.B307().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.B307().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.B307().weightinKGs;
    }
    public boolean isReinforced() { return Transport.B307().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.B307().additionalTextTitle) + Transport.B307().additionalText,
                RailUtility.translate(Transport.B307().additionalTextTitle2) + Transport.B307().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.B307().backTopSpeed: Transport.B307().topSpeed;}
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new B307()};}
