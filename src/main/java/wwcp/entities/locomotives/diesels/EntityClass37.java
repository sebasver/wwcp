...
import java.util.UUID;
    ...
    public class EntityClass37 extends EntityTrainCore {
        ...
        public EntityClass37(UUID owner, World world, double xPos, double yPos, double zPos) {
            super(owner, world, xPos, yPos, zPos);
        }
        public EntityClass37(World world){
            super(world);
        }
        ...
        public ModelBase[] getModel(){return new ModelBase[]{new Class37()};}
