...
public class EntityGP7 extends EntityTrainCore {
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/diesel/GP7/EMD GP7 Demo.png", "textures/bogies/blombergB_black.png",
                "EMD Demonstrator", "Standard EMD demonstrator scheme");
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/diesel/GP7/GP7_CNW_Stripes", "textures/bogies/blombergB_black.png",
                "CNW, Yellow/Green, Stripes", "CNW in yelloow/green scheme with stripes");
