 ...
 */
public class EntityRS18 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityRS18(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityRS18(UUID owner, World world, double xPos, double yPos, double zPos) {
    ...
    @Override
    public String transportName() { return Transport.RS18().name; }

    @Override
    public String transportcountry() { return Transport.RS18().country; }

    @Override
    public String transportYear() { return Transport.RS18().year; }

    @Override
    public String transportFuelType() {
        return Transport.RS18().fuel;
    }
    @Override
    ...
    public float transportTractiveEffort() {
        return Transport.RS18().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.RS18().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.RS18().weightinKGs;
    }
    public boolean isReinforced() { return Transport.RS18().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.RS18().additionalTextTitle) + Transport.RS18().additionalText,
                RailUtility.translate(Transport.RS18().additionalTextTitle2) + Transport.RS18().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.RS18().backTopSpeed: Transport.RS18().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),worldwidecontentpack.MODID, "textures/locomotive/Diesel/RS18/RS18_CN_Stripped.png",
                "textures/bogies/Type_B_Truck.png",
                "CN Stripped", "Canadian National Standard stripped scheme with red nose");
    }

    public String getDefaultSkin(){
        return worldwidecontentpack.MODID+":"+"CN Stripped";
    }
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new RS18()};}
