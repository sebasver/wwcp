...
import wwcp.models.locomotives.diesels.C430;
 ...
 */
public class EntityC430 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityC430(null), worldwidecontentpack.MODID,worldwidecontentpack.America);
    ...
    public EntityC430(UUID owner, World world, double xPos, double yPos, double zPos) {
    ...
    @Override
    public String transportName() { return Transport.C430().name; }


    @Override
    public String transportcountry() { return Transport.C430().country; }

    @Override
    public String transportYear() { return Transport.C430().year; }

    @Override
    public String transportFuelType() {
        return Transport.C430().fuel;
    }
    @Override
    ...
    public float transportTractiveEffort() {
        return Transport.C430().tractive_effort;
    }
    @Override
    public float transportMetricHorsePower() {
        return Transport.C430().metric_horsepower;
    }
    @Override
    public float weightKg() { return  Transport.C430().weightinKGs;
    }
    public boolean isReinforced() { return Transport.C430().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {return new String[]{RailUtility.translate(Transport.C430().additionalTextTitle) + Transport.C430().additionalText,
                RailUtility.translate(Transport.C430().additionalTextTitle2) + Transport.C430().additionalText2};}
    }

    @Override
    public float transportTopSpeed(){return accelerator<0? Transport.C430().backTopSpeed: Transport.C430().topSpeed;}

    @Override
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_NYC.png",
                "NYC", "New York Central bonnet").setBogieTextures(new String[] {"textures/bogies/AmericanTrucks/HiAd4Axel_Black.png", "textures/bogies/AmericanTrucks/HiAd4Axel_Black.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_PC.png",
                "PC", "Penn Central black").setBogieTextures(new String[] {"textures/bogies/AmericanTrucks/HiAd4Axel_Black.png", "textures/bogies/AmericanTrucks/HiAd4Axel_Black.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_Reading.png",
                "Reading", "Reading Railroad cream").setBogieTextures(new String[] {"textures/bogies/Type_B_Truck.png", "textures/bogies/Type_B_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_CRPatch.png",
                "CR Patched Reading", "Conrail patched Reading Railroad").setBogieTextures(new String[] {"textures/bogies/Type_B_Truck.png", "textures/bogies/Type_B_Truck.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_CR.png",
                "CR", "Conrail blue").setBogieTextures(new String[] {"textures/bogies/AmericanTrucks/HiAd4Axel_Black.png", "textures/bogies/AmericanTrucks/HiAd4Axel_Black.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_SCL.png",
                "SCL", "Seaboard Coast Line black").setBogieTextures(new String[] {"textures/bogies/AmericanTrucks/HiAd4Axel_Black.png", "textures/bogies/AmericanTrucks/HiAd4Axel_Black.png"}));
        SkinRegistry.addSkin(this.getClass(), new TransportSkin(worldwidecontentpack.MODID, "textures/locomotive/Diesel/C430/C430_GBW.png",
                "GBW", "Green Bay & Western Railroad").setBogieTextures(new String[] {"textures/bogies/AmericanTrucks/HiAd4Axel_Black.png", "textures/bogies/AmericanTrucks/HiAd4Axel_Black.png"}));

    }

    @Override
    public Bogie[] bogies() {
        if(getCurrentSkin().name.equals("Reading")||getCurrentSkin().name.equals("CR Patched Reading")) {
            return new Bogie[]{
                    new Bogie(new Type_B(), -2.55f, 0f, 0),
                    new Bogie(new Type_B(), 2.55f, 0f, 0)
            };
        } else {
            return new Bogie[]{
                    new Bogie(new HiAd4Axel(), -2.55f, 0f, 0),
                    new Bogie(new HiAd4Axel(), 2.55f, 0f, 0)
            };
        }
    }
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-2.75f,1.4f, -0.3f}};}
    ...
    public float[] getHitboxSize() {
        return new float[]{8.25f,2f,1.5f};
    }
    ...
    public ModelBase[] getModel(){return new ModelBase[]{new C430()};}
