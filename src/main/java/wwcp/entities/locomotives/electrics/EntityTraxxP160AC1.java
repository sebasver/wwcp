...
public class EntityTraxxP160AC1 extends EntityTrainCore {

    public static final Item thisItem = new WWCPTransport(new EntityTraxxP160AC1(null), worldwidecontentpack.MODID, worldwidecontentpack.European);
     ...
     * @see EntityTrainCore
     */
    public EntityTraxxP160AC1(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }

    public EntityTraxxP160AC1(World world) {
        super(world);
    }

    @Override
    public String transportName() {
        return Transport.P160AC1().name;
    }

    @Override
    public String transportcountry() {
        return Transport.P160AC1().country;
    }

    @Override
    public String transportYear() {
        return Transport.P160AC1().year;
    }

    @Override
    public String transportFuelType() {
        return Transport.P160AC1().fuel;
    }

    @Override
    public boolean isFictional() {
        return Transport.P160AC1().fictional;
    }

    @Override
    public float transportTractiveEffort() {
        return Transport.P160AC1().tractive_effort;
    }

    @Override
    public float transportMetricHorsePower() {
        return Transport.P160AC1().metric_horsepower;
    }

    @Override
    public float weightKg() {
        return Transport.P160AC1().weightinKGs;
    }

    public boolean isReinforced() {
        return Transport.P160AC1().reinforced;
    }

    @Override
    public String[] additionalItemText() {
        {
            return new String[]{RailUtility.translate(Transport.P160AC1().additionalTextTitle) + Transport.P160AC1().additionalText,
                    RailUtility.translate(Transport.P160AC1().additionalTextTitle2) + Transport.P160AC1().additionalText2};
        }
    }

    @Override
    public float transportTopSpeed() {
        return accelerator < 0 ? Transport.P160AC1().backTopSpeed : Transport.P160AC1().topSpeed;
    }
