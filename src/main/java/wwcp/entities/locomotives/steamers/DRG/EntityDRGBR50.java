...
public class EntityDRGBR50 extends EntityTrainCore {
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/BR50/DRG/DRG_BR50_no_deflectors(1)_no_plow.png",
                "textures/bogies/BR50/Bogie_BR50.png",
                "DRG BR 50 no deflectors, no plow", "Early versions of BR50 did not have Deflectors, nor a plow");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/BR50/DRG/DRG_BR50_no_deflectors(1)_plow(1).png",
                "textures/bogies/BR50/Bogie_BR50.png",
                "DRG BR 50 no deflector, plow", "Still no deflector, but plows were slowly added.");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/BR50/DRG/DRG_BR50_no_deflectors(1)_plow(2).png",
                "textures/bogies/BR50/Bogie_BR50.png",
                "DRG BR 50 no deflector, plow", "No deflectors, and different plow.");
    }
