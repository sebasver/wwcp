...
public class EntityClass812 extends EntityTrainCore {
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/C812/C1.png",
                "Class 812", "The Class 812 was build by John F. McIntosh for the Caledonean Railway in Scotland.");
