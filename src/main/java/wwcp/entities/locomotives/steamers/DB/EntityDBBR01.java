...
public class EntityDBBR01 extends EntityTrainCore {
    ...
    public float transportTractiveEffort() {
        return Transport.DBBR01().tractive_effort;
    }

    @Override
    public float transportMetricHorsePower() {
        return Transport.DBBR01().metric_horsepower;
    }

    @Override
    public float weightKg() {
        return Transport.DBBR01().weightinKGs;
    }

    @Override
    public String[] additionalItemText() {
        {
            return new String[]{RailUtility.translate(Transport.DBBR01().additionalTextTitle) + Transport.DBBR01().additionalText,
                    RailUtility.translate(Transport.DBBR01().additionalTextTitle2) + Transport.DBBR01().additionalText2};
        }
    }

    @Override
    public float transportTopSpeed() {
        return accelerator < 0 ? Transport.DBBR01().backTopSpeed : Transport.DBBR01().topSpeed;
    }

    @Override
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_wagner(1).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Wagner 1", "DR BR 01 Wagner Deflectors variant 1");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_wagner(2).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Wagner 2", "DR BR 01 Wagner Deflectors variant 2");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_witte(1).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Witte 1", "DR BR 01 Witte Deflectors Variant 1");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_witte(2).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Witte 2", "DR BR 01 Witte Deflectors Variant 2");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_witte(3).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Witte 3", "DR BR 01 Witte Deflectors Variant 3");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_witte(4).png", "textures/bogies/BR01/BR01BogieBlack.png",
    ...
    public boolean isReinforced() {
        return Transport.DBBR01().reinforced;
    }
