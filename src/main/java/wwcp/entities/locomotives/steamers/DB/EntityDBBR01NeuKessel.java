...
public class EntityDBBR01NeuKessel extends EntityTrainCore {
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_Neubaukessel(1).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Neubaukessel 1", "DB BR 01 Neubaukessel variant 1");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_Neubaukessel(2).png", "textures/bogies/BR01/BR01BogieBlack.png",
                "DB BR 01 Neubaukessel 2", "DB BR 01 Neubaukessel variant 2");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_Neubaukessel(3).png", "textures/bogies/BR01/BR01BogieWhite.png",
                "DB BR 01 Neubaukessel 3", "DB BR 01 Neubaukessel variant 3");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/DBBR01/DB_Skin_BR01_Neubaukessel(4).png", "textures/bogies/BR01/BR01BogieWhite.png",
