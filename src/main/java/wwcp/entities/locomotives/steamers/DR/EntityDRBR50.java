...
public class EntityDRBR50 extends EntityTrainCore {
    ...
    public void registerSkins() {
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/BR50/DR/DR_BR50_no_deflectors(1)_no_plow.png",
                "textures/bogies/BR50/Bogie_BR50.png",
                "DB BR 50 no deflectors", "DB BR 50 Wagner Deflectors variant 1");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/BR50/DR/DR_BR50_no_deflectors(1)_plow(1).png",
                "textures/bogies/BR50/Bogie_BR50.png",
                "DB BR 50 Wagner deflector", "DB BR 50 Wagner Deflectors variant 2");
        SkinRegistry.addSkin(this.getClass(), worldwidecontentpack.MODID, "textures/locomotive/Steam/BR50/DR/DR_BR50_no_deflectors(1)_plow(2).png",
                "textures/bogies/BR50/Bogie_BR50.png",
                "DB BR 50 Witte deflectors", "DB BR 50 Witte Deflectors Variant 1");
    }
