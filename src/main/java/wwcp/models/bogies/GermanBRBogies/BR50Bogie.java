...
public class BR50Bogie extends ModelBase //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3].setRotationPoint(-3.5F, 6.5F, -6F);
		...
		bodyModel[4].setRotationPoint(2.5F, 3F, -1F);
		...
		bodyModel[5].setRotationPoint(-4.5F, 5.5F, -6F);
		...
		bodyModel[6].setRotationPoint(-3F, 5F, -2F);
		...
		bodyModel[7].setRotationPoint(-4F, 1.5F, 4.25F);
		...
		bodyModel[8].setRotationPoint(-4F, 1.5F, -5.25F);
	}
}