...
public class BR50Bogie extends ModelBase //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3].setRotationPoint(-40.5F, 6.5F, -6F);
		...
		bodyModel[4].setRotationPoint(-34.5F, 3F, -1F);
		...
		bodyModel[5].setRotationPoint(-41.5F, 5.5F, -6F);
		...
		bodyModel[6].setRotationPoint(-40F, 5F, -2F);
		...
		bodyModel[7].setRotationPoint(-41F, 1.5F, 4.25F);
		...
		bodyModel[8].setRotationPoint(-41F, 1.5F, -5.25F);
	}
}