...
public class MzBogie extends ModelBase //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[7] = new ModelRendererTurbo(this, 145, 1, textureX, textureY); // Box 18
		...
		bodyModel[26] = new ModelRendererTurbo(this, 497, 1, textureX, textureY); // Box 24
		bodyModel[27] = new ModelRendererTurbo(this, 161, 9, textureX, textureY); // Box 27
		bodyModel[28] = new ModelRendererTurbo(this, 201, 9, textureX, textureY); // Box 28
		bodyModel[29] = new ModelRendererTurbo(this, 417, 9, textureX, textureY); // Box 33
		bodyModel[30] = new ModelRendererTurbo(this, 433, 9, textureX, textureY); // Box 33
		bodyModel[31] = new ModelRendererTurbo(this, 241, 17, textureX, textureY); // Box 22
		bodyModel[32] = new ModelRendererTurbo(this, 449, 9, textureX, textureY); // Box 22
		bodyModel[33] = new ModelRendererTurbo(this, 473, 9, textureX, textureY); // Box 22
		bodyModel[34] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Box 22
		bodyModel[35] = new ModelRendererTurbo(this, 25, 17, textureX, textureY); // Box 22
		bodyModel[36] = new ModelRendererTurbo(this, 385, 17, textureX, textureY); // Box 22
		...
		bodyModel[0].setRotationPoint(19.25F, 4F, 0F);
		...
		bodyModel[1].setRotationPoint(-20.25F, 4F, 0F);

		bodyModel[2].addBox(0F, 0F, -5F, 34, 7, 10, 0F); // Box 91
		bodyModel[2].setRotationPoint(-16.5F, 1F, 0F);

		bodyModel[3].addBox(0F, 0F, 0F, 3, 3, 16, 0F); // Box 92
		bodyModel[3].setRotationPoint(12.5F, 4.5F, -8F);

		bodyModel[4].addBox(0F, 0F, -8F, 3, 3, 16, 0F); // Box 93
		bodyModel[4].setRotationPoint(-1.5F, 4.5F, 0F);

		bodyModel[5].addBox(0F, 0F, 0F, 8, 8, 0, 0F); // Box 126
		bodyModel[5].setRotationPoint(10F, 2F, 5.5F);

		bodyModel[6].addBox(0F, 0F, 0F, 8, 8, 0, 0F); // Box 17
		bodyModel[6].setRotationPoint(10.25F, 2F, -5.5F);

		bodyModel[7].addBox(0F, 0F, 0F, 8, 8, 0, 0F); // Box 18
		bodyModel[7].setRotationPoint(-4F, 2F, -5.5F);

		bodyModel[8].addBox(0F, 0F, 0F, 8, 8, 0, 0F); // Box 19
		bodyModel[8].setRotationPoint(-4F, 2F, 5.5F);

		bodyModel[9].addBox(0F, 0F, 0F, 8, 8, 0, 0F); // Box 20
		bodyModel[9].setRotationPoint(-18F, 2F, -5.5F);

		bodyModel[10].addBox(0F, 0F, 0F, 8, 8, 0, 0F); // Box 21
		bodyModel[10].setRotationPoint(-18F, 2F, 5.5F);
		...
		bodyModel[11].setRotationPoint(-19F, 0.5F, -7F);
		...
		bodyModel[13].setRotationPoint(-2.5F, 3.5F, -7.5F);
		...
		bodyModel[14].setRotationPoint(11.5F, 3.5F, -7.5F);
		...
		bodyModel[15].setRotationPoint(-9.5F, 3F, -8F);

		bodyModel[16].addBox(0F, 0F, -8F, 3, 3, 16, 0F); // Box 93
		bodyModel[16].setRotationPoint(-15.5F, 4.5F, 0F);

		bodyModel[17].addBox(0F, 0F, 0F, 4, 2, 4, 0F); // Box 112
		bodyModel[17].setRotationPoint(-1.75F, 0F, -2F);
		...
		bodyModel[18].setRotationPoint(4.5F, 3F, -8F);

		bodyModel[19].addShapeBox(0F, 0F, 0F, 42, 4, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 22
		bodyModel[19].setRotationPoint(-21F, 2.5F, -7F);
		...
		bodyModel[20].setRotationPoint(-18F, 6.5F, -7F);
		...
		bodyModel[21].setRotationPoint(-5F, 0.5F, -7F);
		...
		bodyModel[22].setRotationPoint(-4F, 6.5F, -7F);
		...
		bodyModel[23].setRotationPoint(9F, 0.5F, -7F);
		...
		bodyModel[24].setRotationPoint(10F, 6.5F, -7F);
		...
		bodyModel[25].setRotationPoint(-19F, 0.5F, 6F);
		...
		bodyModel[26].setRotationPoint(-16.5F, 3.5F, 6.5F);
		...
		bodyModel[27].setRotationPoint(-2.5F, 3.5F, 7F);
		...
		bodyModel[28].setRotationPoint(11.5F, 3.5F, 7F);
		...
		bodyModel[30].setRotationPoint(4.5F, 3F, 7F);

		bodyModel[31].addShapeBox(0F, 0F, 0F, 42, 4, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 22
		bodyModel[31].setRotationPoint(-21F, 2.5F, 6F);
		...
		bodyModel[32].setRotationPoint(-18F, 6.5F, 6F);
		...
		bodyModel[33].setRotationPoint(-5F, 0.5F, 6F);
		...
		bodyModel[34].setRotationPoint(-4F, 6.5F, 6F);

		bodyModel[35].addShapeBox(0F, 0F, 0F, 10, 2, 1, 0F,-2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 22
		bodyModel[35].setRotationPoint(9F, 0.5F, 6F);

		bodyModel[36].addShapeBox(0F, 0F, 0F, 8, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F); // Box 22
		bodyModel[36].setRotationPoint(10F, 6.5F, 6F);
	}
}