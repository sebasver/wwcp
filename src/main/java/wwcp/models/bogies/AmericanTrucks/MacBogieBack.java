...
public class MacBogieBack extends ModelBase //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public MacBogieBack() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5].setRotationPoint(-3F, 5.5F, -9F);

		bodyModel[6].addBox(0F, 0F, 0F, 2, 2, 18, 0F); // Box 9
		bodyModel[6].setRotationPoint(11F, 5.5F, -9F);
		...
		bodyModel[7].setRotationPoint(-17F, 5.5F, -9.5F);
		...
		bodyModel[8].setRotationPoint(-3F, 5.5F, -9.5F);
		...
		bodyModel[9].setRotationPoint(11F, 5.5F, -9.5F);
		...
		bodyModel[10].setRotationPoint(-3F, 5.5F, 8.5F);
		...
		bodyModel[11].setRotationPoint(-17F, 5.5F, 8.5F);
		...
		bodyModel[12].setRotationPoint(11F, 5.5F, 8.5F);
		...
		bodyModel[15].addShapeBox(0F, 0F, 0F, 2, 3, 2, 0F,0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 151
		bodyModel[15].setRotationPoint(18F, 2.5F, -9F);

		bodyModel[16].addShapeBox(0F, 0F, 0F, 2, 3, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F); // Box 153
		bodyModel[16].setRotationPoint(18F, 2.5F, -7F);

		bodyModel[17].addBox(0F, 0F, 0F, 2, 3, 10, 0F); // Box 155
		bodyModel[17].setRotationPoint(18F, 3.5F, -5F);

		bodyModel[18].addBox(0F, 0F, 0F, 6, 3, 2, 0F); // Box 24
		bodyModel[18].setRotationPoint(9F, 2F, -9F);

		bodyModel[19].addBox(0F, 0F, 0F, 8, 3, 2, 0F); // Box 26
		bodyModel[19].setRotationPoint(1F, 2.5F, -9F);

		bodyModel[20].addBox(0F, 0F, 0F, 6, 3, 2, 0F); // Box 27
		bodyModel[20].setRotationPoint(-5F, 2F, -9F);

		bodyModel[21].addBox(0F, 0F, 0F, 8, 3, 2, 0F); // Box 28
		bodyModel[21].setRotationPoint(-13F, 2.5F, -9F);

		bodyModel[22].addBox(0F, 0F, 0F, 6, 3, 2, 0F); // Box 29
		bodyModel[22].setRotationPoint(-19F, 2F, -9F);

		bodyModel[23].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 30
		bodyModel[23].setRotationPoint(-20F, 3.5F, -9F);

		bodyModel[24].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, -1F, 0F, 0F); // Box 27
		bodyModel[24].setRotationPoint(-19F, 4.5F, -9F);

		bodyModel[25].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -1F, 0F, -0.5F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 29
		bodyModel[25].setRotationPoint(-15F, 4.5F, -9F);

		bodyModel[26].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -1F, 0F, -0.5F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 30
		bodyModel[26].setRotationPoint(-1F, 4.5F, -9F);

		bodyModel[27].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, -1F, 0F, 0F); // Box 31
		bodyModel[27].setRotationPoint(-5F, 4.5F, -9F);

		bodyModel[28].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, -1F, 0F, 0F); // Box 32
		bodyModel[28].setRotationPoint(9F, 4.5F, -9F);

		bodyModel[29].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -1F, 0F, -0.5F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 33
		bodyModel[29].setRotationPoint(13F, 4.5F, -9F);

		bodyModel[30].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 40
		bodyModel[30].setRotationPoint(3.75F, 5.5F, -8F);

		bodyModel[31].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 41
		bodyModel[31].setRotationPoint(-10.75F, 5.5F, -8F);

		bodyModel[32].addBox(0F, 0F, 0F, 3, 3, 2, 0F); // Box 37
		bodyModel[32].setRotationPoint(15F, 2.5F, -9F);

		bodyModel[33].addShapeBox(0F, 0F, 0F, 2, 3, 2, 0F,0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 38
		bodyModel[33].setRotationPoint(18F, 2.5F, 5F);

		bodyModel[34].addShapeBox(0F, 0F, 0F, 2, 3, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F); // Box 39
		bodyModel[34].setRotationPoint(18F, 2.5F, 7F);

		bodyModel[35].addBox(0F, 0F, 0F, 3, 3, 2, 0F); // Box 40
		bodyModel[35].setRotationPoint(15F, 2.5F, 7F);

		bodyModel[36].addBox(0F, 0F, 0F, 8, 3, 2, 0F); // Box 41
		bodyModel[36].setRotationPoint(-13F, 2.5F, 7F);

		bodyModel[37].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 42
		bodyModel[37].setRotationPoint(-20F, 3.5F, 7F);

		bodyModel[38].addBox(0F, 0F, 0F, 6, 3, 2, 0F); // Box 43
		bodyModel[38].setRotationPoint(-19F, 2F, 7F);

		bodyModel[39].addBox(0F, 0F, 0F, 6, 3, 2, 0F); // Box 44
		bodyModel[39].setRotationPoint(-5F, 2F, 7F);

		bodyModel[40].addBox(0F, 0F, 0F, 8, 3, 2, 0F); // Box 45
		bodyModel[40].setRotationPoint(1F, 2.5F, 7F);

		bodyModel[41].addBox(0F, 0F, 0F, 6, 3, 2, 0F); // Box 46
		bodyModel[41].setRotationPoint(9F, 2F, 7F);

		bodyModel[42].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -1F, 0F, -0.5F); // Box 47
		bodyModel[42].setRotationPoint(-5F, 4.5F, 8F);

		bodyModel[43].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, -0.5F, 0F, 0F, -0.5F); // Box 48
		bodyModel[43].setRotationPoint(-1F, 4.5F, 8F);

		bodyModel[44].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, -0.5F, 0F, 0F, -0.5F); // Box 49
		bodyModel[44].setRotationPoint(-15F, 4.5F, 8F);

		bodyModel[45].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -1F, 0F, -0.5F); // Box 50
		bodyModel[45].setRotationPoint(-19F, 4.5F, 8F);

		bodyModel[46].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -1F, 0F, -0.5F); // Box 51
		bodyModel[46].setRotationPoint(9F, 4.5F, 8F);

		bodyModel[47].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, -0.5F, 0F, 0F, -0.5F); // Box 52
		bodyModel[47].setRotationPoint(13F, 4.5F, 8F);

		bodyModel[48].addBox(0F, 0F, 0F, 11, 6, 11, 0F); // Box 51
		bodyModel[48].setRotationPoint(-18F, 2F, -5.5F);

		bodyModel[49].addBox(0F, 0F, 0F, 11, 6, 11, 0F); // Box 52
		bodyModel[49].setRotationPoint(3F, 2F, -5.5F);

		bodyModel[50].addBox(0F, 0F, 0F, 10, 7, 11, 0F); // Box 53
		bodyModel[50].setRotationPoint(-7F, 1.5F, -5.5F);

		bodyModel[51].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 136
		bodyModel[51].setRotationPoint(-12.5F, 2F, -8.25F);

		bodyModel[52].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 140
		bodyModel[52].setRotationPoint(-16F, 2.45F, -10F);

		bodyModel[53].addShapeBox(0F, 0F, 0F, 1, 0, 2, 0F,0F, 0F, -1F, -1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, -1F, -1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F); // Box 141
		bodyModel[53].setRotationPoint(-13F, 2.45F, -10F);

		bodyModel[54].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 45
		bodyModel[54].setRotationPoint(-18.5F, 1.5F, -10F);

		bodyModel[55].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 62
		bodyModel[55].setRotationPoint(-18.5F, 1.5F, -9F);

		bodyModel[56].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 63
		bodyModel[56].setRotationPoint(-2F, 2.45F, -10F);

		bodyModel[57].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 64
		bodyModel[57].setRotationPoint(1.5F, 2F, -8.25F);

		bodyModel[58].addShapeBox(0F, 0F, 0F, 1, 0, 2, 0F,0F, 0F, -1F, -1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, -1F, -1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F); // Box 65
		bodyModel[58].setRotationPoint(1F, 2.45F, -10F);

		bodyModel[59].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 66
		bodyModel[59].setRotationPoint(-4.5F, 1.5F, -10F);

		bodyModel[60].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 67
		bodyModel[60].setRotationPoint(-4.5F, 1.5F, -9F);

		bodyModel[61].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 124
		bodyModel[61].setRotationPoint(-4F, 1F, -2F);
		...
		bodyModel[62].setRotationPoint(-10F, 1.5F, -9F);
		...
		bodyModel[63].setRotationPoint(4F, 1.5F, -9F);

		bodyModel[64].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 71
		bodyModel[64].setRotationPoint(-2F, 2.45F, 9F);

		bodyModel[65].addShapeBox(0F, 0F, 0F, 1, 0, 2, 0F,-1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, -1F, -1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, -1F); // Box 72
		bodyModel[65].setRotationPoint(1F, 2.45F, 8F);

		bodyModel[66].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 73
		bodyModel[66].setRotationPoint(1.5F, 2F, 7.25F);

		bodyModel[67].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 74
		bodyModel[67].setRotationPoint(-4.5F, 1.5F, 9F);

		bodyModel[68].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 75
		bodyModel[68].setRotationPoint(-4.5F, 1.5F, 8F);

		bodyModel[69].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 76
		bodyModel[69].setRotationPoint(-12.5F, 2F, 7.25F);

		bodyModel[70].addShapeBox(0F, 0F, 0F, 1, 0, 2, 0F,-1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, -1F, -1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, -1F); // Box 77
		bodyModel[70].setRotationPoint(-13F, 2.45F, 8F);

		bodyModel[71].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 78
		bodyModel[71].setRotationPoint(-16F, 2.45F, 9F);

		bodyModel[72].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 79
		bodyModel[72].setRotationPoint(-18.5F, 1.5F, 8F);

		bodyModel[73].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 80
		bodyModel[73].setRotationPoint(-18.5F, 1.5F, 9F);
		...
		bodyModel[74].setRotationPoint(-10F, 1.5F, 7F);
		...
		bodyModel[75].setRotationPoint(4F, 1.5F, 7F);

		bodyModel[76].addBox(0F, 0F, 0F, 6, 1, 0, 0F); // Box 159
		bodyModel[76].setRotationPoint(-12.25F, 7.5F, -8.01F);

		bodyModel[77].addBox(0F, 0F, 0F, 6, 1, 0, 0F); // Box 55
		bodyModel[77].setRotationPoint(2.25F, 7.5F, -8.01F);

		bodyModel[78].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 87
		bodyModel[78].setRotationPoint(-10.75F, 5.5F, 7F);

		bodyModel[79].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 88
		bodyModel[79].setRotationPoint(3.75F, 5.5F, 7F);

		bodyModel[80].addBox(0F, 0F, 0F, 6, 1, 0, 0F); // Box 89
		bodyModel[80].setRotationPoint(2.25F, 7.5F, 8.01F);

		bodyModel[81].addBox(0F, 0F, 0F, 6, 1, 0, 0F); // Box 90
		bodyModel[81].setRotationPoint(-12.25F, 7.5F, 8.01F);
		...
		bodyModel[82].setRotationPoint(-14.5F, 6F, -8.5F);
		...
		bodyModel[83].setRotationPoint(-0.5F, 6F, -8.5F);
		...
		bodyModel[84].setRotationPoint(-14.5F, 6F, 7.5F);
		...
		bodyModel[85].setRotationPoint(-0.5F, 6F, 7.5F);
	}
}