...
public class Blomberg_B extends ModelBase
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[29].setRotationPoint(-3F, 3.25F, -8.75F);

		bodyModel[30].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 103
		bodyModel[30].setRotationPoint(2F, 3.25F, -8.75F);
		...
		bodyModel[62].setRotationPoint(-3F, 3.25F, 7.75F);

		bodyModel[63].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 162
		bodyModel[63].setRotationPoint(2F, 3.25F, 7.75F);
