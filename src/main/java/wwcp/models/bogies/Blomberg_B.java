...
public class Blomberg_B extends ModelBase
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[10].setRotationPoint(12.5F, -2.5F, 3.5F);
		...
		bodyModel[11].setRotationPoint(12.5F, -1.5F, -4.5F);
		...
		bodyModel[12].setRotationPoint(12.5F, -2.5F, -4.5F);
		...
		bodyModel[13].setRotationPoint(-13.5F, -2.5F, 4.5F);
		...
		bodyModel[14].setRotationPoint(12.5F, -2.5F, 4.5F);

		bodyModel[15].addBox(0F, 0F, 0F, 9, 4, 11, 0F); // Box 122
		bodyModel[15].setRotationPoint(-11F, -1.5F, -5.5F);

		bodyModel[16].addBox(0F, 0F, 0F, 9, 4, 11, 0F); // Box 123
		bodyModel[16].setRotationPoint(2F, -1.5F, -5.5F);

		bodyModel[17].addBox(0F, 0F, 0F, 4, 1, 4, 0F); // Box 124
		bodyModel[17].setRotationPoint(-2F, -3F, -2F);
		...
		bodyModel[18].setRotationPoint(-8F, -0.5F, -8.5F);

		bodyModel[19].addBox(0F, 0F, 0F, 25, 1, 1, 0F); // Box 3
		bodyModel[19].setRotationPoint(-12.5F, -2.5F, -8.5F);
		...
		bodyModel[20].setRotationPoint(-4.5F, -3.5F, -8.5F);
		...
		bodyModel[21].setRotationPoint(-6F, -1F, -8.5F);

		bodyModel[22].addBox(0F, 0F, 0F, 7, 1, 1, 0F); // Box 27
		bodyModel[22].setRotationPoint(-3.5F, -1.5F, -8.5F);

		bodyModel[23].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 89
		bodyModel[23].setRotationPoint(-10F, -1.5F, -8.5F);
		...
		bodyModel[24].setRotationPoint(-12.5F, 2F, -8.5F);

		bodyModel[25].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 92
		bodyModel[25].setRotationPoint(6F, -1.5F, -8.5F);
		...
		bodyModel[26].setRotationPoint(-5.5F, 1.5F, -7.75F);
		...
		bodyModel[27].setRotationPoint(4.5F, -1.5F, -7.75F);
		...
		bodyModel[28].setRotationPoint(4.5F, 1.5F, -7.75F);

		bodyModel[29].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 102
		bodyModel[29].setRotationPoint(-3F, -2.25F, -8.75F);

		bodyModel[30].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 103
		bodyModel[30].setRotationPoint(2F, -2.25F, -8.75F);
		...
		bodyModel[31].setRotationPoint(-10F, 0F, -9.5F);
		...
		bodyModel[32].setRotationPoint(-2.75F, 2.5F, -9.5F);
		...
		bodyModel[33].setRotationPoint(-2.25F, -0.75F, -6F);
		...
		bodyModel[34].setRotationPoint(8F, 0F, -9.5F);
		...
		bodyModel[35].setRotationPoint(-12F, -3.5F, -8.5F);
		...
		bodyModel[36].setRotationPoint(6F, -3.5F, -8.5F);
		...
		bodyModel[37].setRotationPoint(-12F, -1.5F, -8.5F);

		bodyModel[38].addBox(0F, 0F, 0F, 25, 1, 1, 0F); // Box 114
		bodyModel[38].setRotationPoint(-12.5F, -2.5F, 7.5F);

		bodyModel[39].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 116
		bodyModel[39].setRotationPoint(-10F, -1.5F, 7.5F);
		...
		bodyModel[40].setRotationPoint(-12F, -1.5F, 7.5F);

		bodyModel[41].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 121
		bodyModel[41].setRotationPoint(6F, -1.5F, 7.5F);
		...
		bodyModel[42].setRotationPoint(10F, -1.5F, 7.5F);
		...
		bodyModel[43].setRotationPoint(6F, -3.5F, 7.5F);
		...
		bodyModel[44].setRotationPoint(-4.5F, -3.5F, 7.5F);
		...
		bodyModel[45].setRotationPoint(-12F, -3.5F, 7.5F);

		bodyModel[46].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 60
		bodyModel[46].setRotationPoint(6F, -3F, 8.5F);
		...
		bodyModel[47].setRotationPoint(5F, -3F, 5.5F);

		bodyModel[48].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 62
		bodyModel[48].setRotationPoint(7.5F, -3.45F, 8.5F);
		...
		bodyModel[49].setRotationPoint(-6F, -3F, 5.5F);

		bodyModel[50].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 145
		bodyModel[50].setRotationPoint(-8F, -3F, 8.5F);

		bodyModel[51].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 146
		bodyModel[51].setRotationPoint(-9.5F, -3.45F, 8.5F);

		bodyModel[52].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 147
		bodyModel[52].setRotationPoint(-8F, -3F, -9.5F);

		bodyModel[53].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 148
		bodyModel[53].setRotationPoint(7.5F, -3.45F, -9.5F);

		bodyModel[54].addBox(0F, 0F, 0F, 2, 0, 1, 0F); // Box 149
		bodyModel[54].setRotationPoint(6F, -3F, -9.5F);
		...
		bodyModel[55].setRotationPoint(5F, -3F, -9.5F);
		...
		bodyModel[56].setRotationPoint(-6F, -3F, -9.5F);

		bodyModel[57].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 152
		bodyModel[57].setRotationPoint(-9.5F, -3.45F, -9.5F);
		...
		bodyModel[58].setRotationPoint(4.5F, -1.5F, 6.75F);
		...
		bodyModel[59].setRotationPoint(4.5F, 1.5F, 6.75F);
		...
		bodyModel[60].setRotationPoint(-5.5F, -1.5F, 6.75F);
		...
		bodyModel[61].setRotationPoint(-5.5F, 1.5F, 6.75F);

		bodyModel[62].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 161
		bodyModel[62].setRotationPoint(-3F, -2.25F, 7.75F);

		bodyModel[63].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 162
		bodyModel[63].setRotationPoint(2F, -2.25F, 7.75F);
		...
		bodyModel[64].setRotationPoint(8F, 0F, 8.5F);
		...
		bodyModel[65].setRotationPoint(-10F, 0F, 8.5F);
		...
		bodyModel[66].setRotationPoint(-3.25F, -2F, -9F);

		bodyModel[67].addBox(-3.5F, -3.5F, 0F, 7, 7, 0, 0F); // Box 9
		bodyModel[67].setRotationPoint(-9F, 1F, 5.95F);

		bodyModel[68].addBox(-3.5F, -3.5F, 0F, 7, 7, 0, 0F); // Box 39
		bodyModel[68].setRotationPoint(-9F, 1F, -5.95F);

		bodyModel[69].addBox(-3.5F, -3.5F, 0F, 7, 7, 0, 0F); // Box 6
		bodyModel[69].setRotationPoint(9F, 1F, 5.95F);

		bodyModel[70].addBox(-3.5F, -3.5F, 0F, 7, 7, 0, 0F); // Box 8
		bodyModel[70].setRotationPoint(9F, 1F, -5.95F);
		...
		bodyModel[71].setRotationPoint(3F, -1F, -8.5F);
		...
		bodyModel[72].setRotationPoint(-8F, -0.5F, -8.5F);
		...
		bodyModel[73].setRotationPoint(3.5F, 2F, -8.5F);
		...
		bodyModel[74].setRotationPoint(-13.5F, -1.5F, -7.25F);

		bodyModel[75].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 121
		bodyModel[75].setRotationPoint(-12.5F, 0F, -7.5F);
		...
		bodyModel[77].setRotationPoint(12.5F, -1.5F, -7.25F);
		...
		bodyModel[78].setRotationPoint(-2F, 0F, -8F);
		...
		bodyModel[79].setRotationPoint(-2F, 1.5F, -8F);
		...
		bodyModel[80].setRotationPoint(-2F, 1.11022302462516E-16F, 6F);
		...
		bodyModel[81].setRotationPoint(-2F, 1.5F, 6F);
		...
		bodyModel[82].setRotationPoint(-2F, 1.1F, -9F);
		...
		bodyModel[83].setRotationPoint(-2F, 0.4F, -9F);
		...
		bodyModel[84].setRotationPoint(-2F, 0.75F, -10F);
		...
		bodyModel[85].setRotationPoint(-2F, 1.1F, 6F);
		...
		bodyModel[86].setRotationPoint(-2F, 0.4F, 6F);
		...
		bodyModel[87].setRotationPoint(-2F, 0.75F, 7F);
		...
		bodyModel[88].setRotationPoint(1.75F, -2F, -9F);
		...
		bodyModel[89].setRotationPoint(-2.75F, 2.5F, 8.5F);
		...
		bodyModel[90].setRotationPoint(1.75F, -2F, 8F);
		...
		bodyModel[91].setRotationPoint(-3.25F, -2F, 8F);
		...
		bodyModel[92].setRotationPoint(3.5F, 2F, 7.5F);
		...
		bodyModel[93].setRotationPoint(-12.5F, 2F, 7.5F);

		bodyModel[94].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 140
		bodyModel[94].setRotationPoint(-12.5F, 0F, 6.5F);
		...
		bodyModel[95].setRotationPoint(-13.5F, -1.5F, 6.25F);

		bodyModel[96].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 142
		bodyModel[96].setRotationPoint(11.5F, 0F, 6.5F);
		...
		bodyModel[97].setRotationPoint(12.5F, -1.5F, 6.25F);
		...
		bodyModel[98].setRotationPoint(6F, -0.5F, -8.5F);
		...
		bodyModel[99].setRotationPoint(6F, -0.5F, -8.5F);

		bodyModel[100].addBox(0F, 0F, 0F, 7, 1, 1, 0F); // Box 107
		bodyModel[100].setRotationPoint(-3.5F, -1.5F, 7.5F);
		...
		bodyModel[101].setRotationPoint(6F, -0.5F, 7.5F);
		...
		bodyModel[102].setRotationPoint(6F, -0.5F, 7.5F);
		...
		bodyModel[103].setRotationPoint(3F, -1F, 7.5F);
		...
		bodyModel[104].setRotationPoint(-6F, -1F, 7.5F);
		...
		bodyModel[105].setRotationPoint(-8F, -0.5F, 7.5F);
		...
		bodyModel[106].setRotationPoint(-8F, -0.5F, 7.5F);
	}
}