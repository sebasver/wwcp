...
public class PlatformStationLamp extends ModelBase //Same as Filename
{
	int textureX = 256;
	int textureY = 128;

	public PlatformStationLamp() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[21] = new ModelRendererTurbo(this, 2, 33, textureX, textureY); // Import ImportImportBox4
		...
		bodyModel[0].setRotationPoint(-0.5F, -46F, -0.5F);
		...
		bodyModel[1].setRotationPoint(-0.5F, -51F, -4.5F);
		...
		bodyModel[2].setRotationPoint(-0.5F, -54F, -14.5F);

		bodyModel[3].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 3
		bodyModel[3].setRotationPoint(-0.5F, -53F, -12.5F);
		...
		bodyModel[10].setRotationPoint(0.5F, -51F, -12.5F);
		...
		bodyModel[11].setRotationPoint(-0.5F, -51F, -11.5F);
		...
		bodyModel[12].setRotationPoint(-0.5F, -51F, -15.5F);
		...
		bodyModel[13].setRotationPoint(-0.5F, -49F, -12.5F);
		...
		bodyModel[14].setRotationPoint(-3.5F, -36F, -2F);
		...
		bodyModel[15].setRotationPoint(-6.5F, -35F, -2F);
		...
		bodyModel[16].setRotationPoint(3.5F, -35F, -2F);
		...
		bodyModel[17].setRotationPoint(3.5F, -36F, -2F);
		...
		bodyModel[18].setRotationPoint(3.5F, -34F, -2F);
		...
		bodyModel[19].setRotationPoint(-4.5F, -34F, -2F);
		...
		bodyModel[20].setRotationPoint(-4.5F, -36F, -2F);

		bodyModel[21].addBox(0F, 0F, 0F, 16, 6, 16, 0F); // Import ImportImportBox4
		bodyModel[21].setRotationPoint(-8F, -6F, -8F);

		bodyModel[22].addShapeBox(0F, 0F, 0F, 1, 11, 1, 0F,1F, 0F, 1F, 1F, 0F, 1F, 1F, 0F, 1F, 1F, 0F, 1F, 1F, 0F, 1F, 1F, 0F, 1F, 1F, 0F, 1F, 1F, 0F, 1F); // Box 22
		bodyModel[22].setRotationPoint(-0.5F, -17F, -0.5F);
	}
}