...
public class ModelTelegraphstraightDiagonalUp extends ModelBase //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelTelegraphstraightDiagonalUp() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5].setRotationPoint(0F, -64.01F, 7F);

		bodyModel[6].addBox(0F, 0F, 0F, 48, 0, 1, 0F); // Box 9
		bodyModel[6].setRotationPoint(-48F, -48.01F, -8F);

		bodyModel[7].addBox(0F, 0F, 0F, 48, 0, 1, 0F); // Box 10
		bodyModel[7].setRotationPoint(-48F, -48.01F, -0.5F);

		bodyModel[8].addBox(0F, 0F, 0F, 48, 0, 1, 0F); // Box 11
		bodyModel[8].setRotationPoint(-48F, -48.01F, 7F);
		...
		bodyModel[9].setRotationPoint(0F, -64.01F, -0.5F);
		...
		bodyModel[10].setRotationPoint(0F, -64.01F, -8F);
	}
}