...
// Model: 
// Model Creator: 
// Created on: 03.10.2019 - 19:04:36
// Last changed on: 03.10.2019 - 19:04:36
...
public class ModelTelegraphDiagonal extends ModelBase //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelTelegraphDiagonal() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5] = new ModelRendererTurbo(this, 57, 1, textureX, textureY); // Box 8
		bodyModel[6] = new ModelRendererTurbo(this, 161, 1, textureX, textureY); // Box 11
		bodyModel[7] = new ModelRendererTurbo(this, 265, 1, textureX, textureY); // Box 12
		bodyModel[8] = new ModelRendererTurbo(this, 369, 1, textureX, textureY); // Box 8
		bodyModel[9] = new ModelRendererTurbo(this, 17, 25, textureX, textureY); // Box 11
		bodyModel[10] = new ModelRendererTurbo(this, 121, 25, textureX, textureY); // Box 12
		...
		bodyModel[5].setRotationPoint(0F, -64.2F, 7F);

		bodyModel[6].addShapeBox(0F, 0F, 0F, 48, 16, 1, 0F,0F, -16F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -16F, 0F, 0F, 0F, 0F, 0F, -16F, 0F, 0F, -16F, 0F, 0F, 0F, 0F); // Box 11
		bodyModel[6].setRotationPoint(0F, -64.2F, -0.5F);

		bodyModel[7].addShapeBox(0F, 0F, 0F, 48, 16, 1, 0F,0F, -16F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -16F, 0F, 0F, 0F, 0F, 0F, -16F, 0F, 0F, -16F, 0F, 0F, 0F, 0F); // Box 12
		bodyModel[7].setRotationPoint(0F, -64.2F, -8F);

		bodyModel[8].addShapeBox(0F, 0F, 0F, 48, 16, 1, 0F,0F, -16F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -16F, 0F, 0F, 0F, 0F, 0F, -16F, 0F, 0F, -16F, 0F, 0F, 0F, 0F); // Box 8
		bodyModel[8].setRotationPoint(-48F, -48.2F, 7F);
		...
		bodyModel[9].setRotationPoint(-48F, -48.2F, -0.5F);
		...
		bodyModel[10].setRotationPoint(-48F, -48.2F, -8F);
	}
}